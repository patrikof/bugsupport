...
public class RelatorioJasper {
	 ...
	 * 
	 * FacesUtil .addInfo("Visualiza��o do Relat�rio Executada com Sucesso!"); }
	 * else { FacesUtil
	 * .addError("Erro 1 - Falha na Visualiza��o do Relat�rio!"); }
	 * 
	 * } catch (Exception e) { FacesUtil .addError(
	 * "Erro 2 - Ocorreu um erro ao tentar Visualizar o Relat�rio. Mensagem T�cnica: "
	 ...
	 * 
	 * //gera o relat�rio exporter.exportReport();
	 * 
	 * //return out;
	 * 
	 * 
	 * } catch (Exception e) { FacesUtil .addError(
	 * "Erro 2 - Ocorreu um erro ao tentar gerar o PDF da pesquisa. Mensagem T�cnica: "
	 * + e.getMessage()+ " StackTrace:" + e.getStackTrace().toString()); }
	 * //return null; }
	 * 
	 * 
	...
	public static <T> void imprimir(List<T> lista, String reportUrl,
		...
		try {
			...
			/*
			 * if (!AchouArquivo) {
			 * System.out.println("Url Real Encontrada mais n�o existe...");
			...
			if (!AchouArquivo) {
				System.out.println("Url Real Encontrada mais n�o existe...");
				System.out.println("M�todo 3(era o 4):");
				System.out.println("Arquivo passado:" + reportUrl);
			...
			if (reportUrlReal != null) {
				...
				if (AchouArquivo)
					System.out
							.println("Ap�s todas as tentativas achou o arquivo!!!");
				else
					System.out
							.println("Ap�s todas as tentativas n�o achou o arquivo");
			} else {
				System.out
						.println("Ap�s todas as tentativas a URL Real ainda ficou NULL");
			}
			...
			FacesUtil
					.addError("Ocorreu um erro ao tentar gerar o PDF. Mensagem T�cnica: "
							+ e.getMessage());
			e.printStackTrace();
		} finally {
			try {
