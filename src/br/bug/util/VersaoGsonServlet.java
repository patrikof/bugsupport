...
import br.bug.service.VersaoService;
...
public class VersaoGsonServlet extends HttpServlet implements
	...
	@Autowired
	private VersaoService gerenciador;
	...
	public void handleRequest(HttpServletRequest request,
		...
		VersaoService gv = getGerenciador();
		if (IdVersao != null) {
	...
	public VersaoService getGerenciador() {
		return gerenciador;
	}

	public void setGerenciador(VersaoService gerenciador) {
