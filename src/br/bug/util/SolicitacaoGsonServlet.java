...
import br.bug.controller.BuscaSolicitacaoBean;
import br.bug.controller.SolicitacaoBean;
...
public class SolicitacaoGsonServlet extends HttpServlet implements
	...
	public void handleRequest(HttpServletRequest request,
		...
		SolicitacaoService gs = getGerenciador();
		...
		if (IdSolicitacaoRm != null) {
					...
					( usuarioLogado.getPapeis().contains(papelAdmin) ))
			{
				...
				/*RequestDispatcher dispatcher = request
						.getRequestDispatcher("/view/solicitacao/form.jsf");
				dispatcher.forward(request, response);*/
				
				
				response.sendRedirect(request.getContextPath()+"/view/solicitacao/form.jsf");
	...
	public SolicitacaoService getGerenciador() {
		return gerenciador;
	}

	public void setGerenciador(SolicitacaoService gerenciador) {
